import { Product, ProductCollectionService, ProductService, ProductVariantService, ShippingProfileService, StoreService } from "@medusajs/medusa"
...
let mockedShopifyClientService: jest.Mocked<ShopifyClientService> = ShopifyClientServiceMock as any;
let mockedProductService: jest.Mocked<ProductService> = ProductServiceMock as any;
let mockedProductVariantService: jest.Mocked<ProductVariantService> = ProductVariantServiceMock as any;
let mockedShippingProfileService: jest.Mocked<ShippingProfileService> = ShippingProfileServiceMock as any;
let mockedShopifyRedisService: jest.Mocked<ShopifyRedisService> = ShopifyRedisServiceMock as any;
